<template>
     <div class="brandZone" v-show="showBox">
       <div class="brandBox">
          <div class="col1">
            <div class="indexList">
              <md-scroll-view
                ...
                auto-reflow
              >
                <span class="stxt" :data-index="item"   v-for="item of charts" :key="item" @click="toView(item,$event)">{{item}}</span>
              </md-scroll-view>
            </div>
            <div class="l1List" ref="lv1">
              ...
              >
                <div v-for="item of col1Data"  :key="item.name">
                  ...
                  <span class="stxt" v-for="sub of item.list" :id="`col1${sub.value}`" :key="sub.value" @click="loadLv2(sub,$event)">{{sub.label}}</span>
                </div>
          ...
          <div class="col2">
            ...
            >
              <div>
                   <span class="ltxt" v-for="item of col2Data"  :key="item.value" :id="`col2${item.value}`" @click="loadLv3(item,$event)">
               {{item.label}}
             </span>
              </div>
            </md-scroll-view>
         ...
         <div class="closeBox" @click="doOk">完成</div>
       </div>
     </div>
</template>
  ...
  methods: {
   ...
   //   this.$emit('input', this.resArr);
    ...
    doOk(){
      ...
      // this.$emit('change', `${this.str2} ${this.str3}`);
      // this.$emit('input', this.resArr);
